...
func (m *MockGameRepository) GetByStatus(ctx context.Context, status entity.GameStatus) ([]*entity.Game, error) {
...
func (m *MockGameRepository) UpdateStatus(ctx context.Context, gameID int64, status entity.GameStatus) error {
