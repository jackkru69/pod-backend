...
import (
	...
	"pod-backend/config"
	amqprpc "pod-backend/internal/controller/amqp_rpc"
	"pod-backend/internal/controller/grpc"
	"pod-backend/internal/controller/http"
	natsrpc "pod-backend/internal/controller/nats_rpc"
	"pod-backend/internal/repo/persistent"
	"pod-backend/internal/repo/webapi"
	"pod-backend/internal/usecase/translation"
	"pod-backend/pkg/grpcserver"
	"pod-backend/pkg/httpserver"
	"pod-backend/pkg/logger"
	natsRPCServer "pod-backend/pkg/nats/nats_rpc/server"
	"pod-backend/pkg/postgres"
	rmqRPCServer "pod-backend/pkg/rabbitmq/rmq_rpc/server"
)
...
func Run(cfg *config.Config) { //nolint: gocyclo,cyclop,funlen,gocritic,nolintlint
	...
	http.NewRouter(httpServer.App, cfg, translationUseCase, l, pg)
