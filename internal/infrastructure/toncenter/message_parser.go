...
// These are auto-generated by Tact compiler based on message name hashes.
// Format: First 32 bits of SHA256(message_name) in big-endian.
const (
	// GameInitializedNotify opcode (0xEB292097)
	// Base64: 6ykglw==
	OpcodeGameInitializedNotify uint32 = 0xEB292097

	// GameStartedNotify opcode (0xB11BE55F)
	// Base64: sRvlXw==
	OpcodeGameStartedNotify uint32 = 0xB11BE55F

	// GameFinishedNotify opcode - calculated from Tact message name
	OpcodeGameFinishedNotify uint32 = 0x5D8E7D3B

	// GameCancelledNotify opcode
	OpcodeGameCancelledNotify uint32 = 0x94A6D73F

	// SecretOpenedNotify opcode
	OpcodeSecretOpenedNotify uint32 = 0x7C5E4A2D

	// DrawNotify opcode
	OpcodeDrawNotify uint32 = 0x3A9B5C1E

	// InsufficientBalanceNotify opcode
	OpcodeInsufficientBalanceNotify uint32 = 0x8D4F2E6A
)
